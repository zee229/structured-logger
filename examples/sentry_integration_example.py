...
def main():
    ...
    sentry_config = SentryConfig(
        ...
        default_tags={
            "service": "structured-logger-example",
            "component": "demo"
        },
    ...
    logger.info("This is a regular info message", extra={
        "user_id": "user123",
        "company_id": "company456",
        "request_id": "req789"
    })
    ...
    logger.warning("This is a warning message", extra={
        "user_id": "user123",
    ...
    logger.error("This is an error message that will be sent to Sentry", extra={
        "user_id": "user123",
        "company_id": "company456",
    ...
    try:
        ...
        logger.exception("Division by zero error occurred", extra={
            "user_id": "user123",
    ...
    logger.error("Payment processing failed due to fraud detection", extra={
        "user_id": "user123",
        "company_id": "company456",
        "transaction_id": "txn_12345",
        "fraud_score": 85,
    ...
    print("Note: Make sure to set SENTRY_DSN environment variable with your actual Sentry DSN")
